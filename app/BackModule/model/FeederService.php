...
namespace Eshopblank\BackModule\Model;

use Curl\Curl;
use Eshopblank\Model\Category;
use Eshopblank\Model\CategoryParent;
use Eshopblank\Model\Product;
...
class FeederService{
    ...
    public function feedOneHourProducts(){
        ...
        foreach ($xml->product as $item){
            ...
            $product->catalogPrice = intval($item->catalogPrice);
            $product->catalogPriceVat = intval($item->catalogPriceVAT);
            $product->clientPrice = intval($item->clientPrice);
            $product->clientPriceVat = intval($item->clientPriceVAT);
            $product->retailPrice = intval($item->retailPrice);
