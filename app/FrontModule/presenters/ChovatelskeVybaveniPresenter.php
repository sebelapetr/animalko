...
class ChovatelskeVybaveniPresenter extends BasePresenter{
    ...
    public function renderDefault($id=2, $page=1, $orderBy = null, $direction = null){
        ...
        $this->getTemplate()->setFile(__DIR__ . "/../templates/ChovatelskeVybaveni/kategorie.latte");
        ...
        $this->getTemplate()->parentCategories = $this->orm->categoryParents->findBy(['parent'=>2, 'visible'=>1])->orderBy('priority', 'ASC'); /* -VŠECHNY RODIČOVSKÉ KATEGORIE VE VET. VYBAVENÍ- */
        ...
        $this->getTemplate()->productsCount = 8110  ;//count($products);
